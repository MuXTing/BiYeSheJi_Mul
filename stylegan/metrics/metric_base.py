...
ls_9 = dnnlib.EasyDict(func_name='metrics.linear_separability.LS', name='ls_9', num_samples=100000, num_keep=10000, attrib_indices=[9], minibatch_per_gpu=4)
ls_3 = dnnlib.EasyDict(func_name='metrics.linear_separability.LS', name='ls_3', num_samples=100000, num_keep=10000, attrib_indices=[3], minibatch_per_gpu=4)
ls_8 = dnnlib.EasyDict(func_name='metrics.linear_separability.LS', name='ls_8', num_samples=100000, num_keep=10000, attrib_indices=[8], minibatch_per_gpu=4)
ls_34 = dnnlib.EasyDict(func_name='metrics.linear_separability.LS', name='ls_34', num_samples=100000, num_keep=10000, attrib_indices=[34], minibatch_per_gpu=4)
